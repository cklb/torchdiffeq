...
def rk4_alt_step_func(func, t, dt, y, k1=None):
    ...
    k3 = func(t + dt * 2 / 3, tuple(y_ + dt_ * (k1_ / -3 + k2_) for y_, k1_, k2_ in zip(y, k1, k2)))
    k4 = func(t + dt, tuple(y_ + dt_ * (k1_ - k2_ + k3_) for y_, k1_, k2_, k3_ in zip(y, k1, k2, k3)))
    return tuple((k1_ + 3 * k2_ + 3 * k3_ + k4_) * (dt_ / 8) for k1_, k2_, k3_, k4_ in zip(k1, k2, k3, k4))
